...
void chatterCallbackAdversaryPosition(const user_input::person_position::ConstPtr& msg)
{
  printf("Updating the person's position\n");
  xPosAdversary = msg->xpos;
  yPosAdversary = msg->ypos;
  thRotAdversary = msg->theta;
}
...
int main(int argc , char *argv[])
{
  ...
  ros::Subscriber subAdv1 = n.subscribe("adversary_1_position", 1000, chatterCallbackAdversaryPosition);
  ros::Subscriber subAdv2 = n.subscribe("adversary_2_position", 1000, chatterCallbackAdversaryPosition);
  ros::Subscriber subAdv3 = n.subscribe("adversary_3_position", 1000, chatterCallbackAdversaryPosition);
